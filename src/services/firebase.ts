 ...
 * Uses the already-authorized WB-M well catalog — does NOT download packets.
 */
...
/**
 * Get raw performance data for a single well via getDriverWellPerformance.
 * Server Admin-reads only the authorized performance/{wellKey} node.
 */
 ...
 * Preserves existing client stats/UI calculations.
 */
