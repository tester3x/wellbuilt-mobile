...
/**
 * Numeric keypad (BBLs) — digits/decimal only.
 * Empty is committable so WB-M well-down / missing-barrel submit validation
 * can run; measurement symbols (' " space) cannot become a BBL value.
 * Zero is allowed (level-only pull).
 */
